...
public class ToughTorchGUI extends JFrame {

	private JTabbedPane severalPanels;
	private ToughTorchMap theModel;
	...
	public static void main(String[] args) {
		new ToughTorchGUI(null).setVisible(true);

	}

	public ToughTorchGUI(User user) {
		currentUser = user;
		layoutThisJFrame();
		registerListeners();
	...
	public void layoutThisJFrame() {
		...
		StringView = new ToughTorchTextView();
		GUIView = new ToughTorchDigitalView();
	...
	public void setUpModelAndObservers() {
		theModel = new ToughTorchMap(currentUser);
