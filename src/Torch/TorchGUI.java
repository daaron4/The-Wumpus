...
public class TorchGUI extends JFrame {

	private JTabbedPane severalPanels;
	private TorchMap theModel;
	...
	public static void main(String[] args) {
		new TorchGUI(null).setVisible(true);

	}

	public TorchGUI(User user) {
		currentUser = user;
		layoutThisJFrame();
		registerListeners();
	...
	public void layoutThisJFrame() {
		...
		StringView = new TorchTextView();
		GUIView = new TorchDigitalView();
	...
	public void setUpModelAndObservers() {
		theModel = new TorchMap(currentUser);
