...
public class ClassicGUI extends JFrame {

	private JTabbedPane severalPanels;
	private ClassicMap theModel;
	...
	public static void main(String[] args) {
		new ClassicGUI(null).setVisible(true);

	}

	public ClassicGUI(User user) {
		currentUser = user;
		layoutThisJFrame();
		registerListeners();
	...
	public void layoutThisJFrame() {
		...
		StringView = new ClassicTextView();
		GUIView = new ClassicDigitalView();
	...
	public void setUpModelAndObservers() {
		theModel = new ClassicMap(currentUser);
